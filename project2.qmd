...
```{r}
#| fig-alt: "A bar chart with counts of light and dark words in Hamlet, Macbeth, and Romeo and Juliet."
...
```{r}
#| fig-alt: "A bar chart showing the counts of opposite word pairs in Romeo and Juliet."
...
```{r}
#| fig-alt: "A bar chart showing the counts of opposite word pairs in Hamlet."
...
```{r}
#| fig-alt: "A bar chart showing the counts of opposite word pairs in Macbeth."
