...
```{r}
#| label: water_insecurity-plot
#| fig-cap: "People Lacking Plumbing and Population in every US county"
#| fig-alt: "A scatter plot showing the relationship between county population and the percentage of people lacking plumbing."
...
```{r}
#| label: state-plot
#| fig-cap: "Mean State Percentage of People Lacking Plumbing by Region"
#| fig-alt: "A jitter plot showing the mean percentage of people lacking plumbing for every state, grouped by US Census region. Outlier states with values over 0.4% are labeled."
...
```{r}
#| label: outlier-plot
#| fig-cap: "Percent Lacking Plumbing in AK, AZ and NM counties"
#| fig-alt: "A scatter plot showing the percentage of people lacking plumbing in counties in Alaska, Arizona, and New Mexico. Counties with values over 0.6% are labeled."
...
```{r}
#| label: county-plot
#| fig-cap: "Percent Lacking Plumbing and Native American Percent of County Population"
#| fig-alt: "A scatter plot showing the relationship between percentage of people lacking plumbing and the Native American population as a percent of total population. Counties with values over 0.9% are labeled."
ggplot(clean_data, 
       aes(x = IA_prop * 100, 
           y = percent_lacking_plumbing)) +
