...
```{r}
#| fig-alt: "A box plot showing the bill length of female vs male pengiuns from the Palmer Penguins data set." 
...
```{r}
#| fig-alt: "A histogram showing the distribution of mean differences under the null using the permutation function, with the observed difference shown in red." 
perm_data %>% 
  ggplot(aes(
    x = perm_avg_diff)) +
  geom_histogram() + 
